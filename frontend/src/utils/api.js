...
export const subscriptionAPI = {
  ...
  getUserDevices: () => api.get('/subscriptions/user-devices'),
...
export const notificationAPI = {
  ...
  // 管理端通知
  getAdminNotifications: (params) => api.get('/notifications/admin/notifications', { params }),
  ...
  // 邮件模板
  getEmailTemplates: () => api.get('/notifications/admin/email-templates'),
  createEmailTemplate: (data) => api.post('/notifications/admin/email-templates', data),
  updateEmailTemplate: (templateId, data) => api.put(`/notifications/admin/email-templates/${templateId}`, data),
  deleteEmailTemplate: (templateId) => api.delete(`/notifications/admin/email-templates/${templateId}`),
  previewEmailTemplate: (templateName, variables) => api.post(`/notifications/admin/email-templates/${templateName}/preview`, variables)
}
...
export const configAPI = {
  ...
  getSystemConfig: () => api.get('/config/admin/system-config'),
  updateSystemConfig: (data) => api.post('/config/admin/system-config', data)
}

// 统计相关API
export const statisticsAPI = {
  getUserStatistics: (params) => api.get('/statistics/admin/statistics/users', { params }),
  getSubscriptionStatistics: () => api.get('/statistics/admin/statistics/subscriptions'),
  getOrderStatistics: (params) => api.get('/statistics/admin/statistics/orders', { params }),
  getStatisticsOverview: () => api.get('/statistics/admin/statistics/overview'),
  exportStatistics: (type, format) => api.get('/statistics/admin/statistics/export', { params: { type, format } })
}
