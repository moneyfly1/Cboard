...
const routes = [
  ...
  // 管理端路由
  {
    ...
    children: [
      ...
      { path: 'node-speed-control', name: 'AdminNodeSpeedControl', component: () => import('@/views/admin/NodeSpeedControl.vue'), meta: { title: '节点测速控制', breadcrumb: [{ title: '管理后台', path: '/admin/dashboard' }, { title: '节点测速控制', path: '/admin/node-speed-control' }] } },
