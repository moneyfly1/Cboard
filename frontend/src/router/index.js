...
const routes = [
  ...
  // 管理端路由
  {
    ...
    children: [
      ...
      { path: 'config-update-test', name: 'AdminConfigUpdateTest', component: () => import('@/views/admin/ConfigUpdateTest.vue'), meta: { title: '配置更新测试', breadcrumb: [{ title: '管理后台', path: '/admin/dashboard' }, { title: '配置更新测试', path: '/admin/config-update-test' }] } },
